...
import DebuggingMindset from '../../../../assets/debugging-pipelines/debugging-mindset.svg';
import QuickWinsChecklist from '../../../../assets/debugging-pipelines/quick-wins-checklist.svg';
import ErrorNpm404 from '../../../../assets/debugging-pipelines/error-npm-404.svg';
import ErrorTimeout from '../../../../assets/debugging-pipelines/error-timeout.svg';
import ErrorEnvironment from '../../../../assets/debugging-pipelines/error-environment.svg';
import ErrorPermission from '../../../../assets/debugging-pipelines/error-permission.svg';
import ErrorOom from '../../../../assets/debugging-pipelines/error-oom.svg';
...
<img src={DebuggingMindset.src} alt="The debugging cycle showing iterative problem-solving" style="max-width: 100%; height: auto;" />
...
<img src={QuickWinsChecklist.src} alt="Quick wins checklist with time estimates" style="max-width: 100%; height: auto;" />
...
<img src={ErrorNpm404.src} alt="Annotated npm 404 error example" style="max-width: 100%; height: auto; margin: 2rem 0;" />
...
<img src={ErrorTimeout.src} alt="Annotated test timeout error example" style="max-width: 100%; height: auto; margin: 2rem 0;" />
...
<img src={ErrorEnvironment.src} alt="Annotated environment variable error example" style="max-width: 100%; height: auto; margin: 2rem 0;" />
...
<img src={ErrorPermission.src} alt="Annotated permission denied error example" style="max-width: 100%; height: auto; margin: 2rem 0;" />
...
<img src={ErrorOom.src} alt="Annotated out of memory error example" style="max-width: 100%; height: auto; margin: 2rem 0;" />
